import { InSocket, Node, NodeOutputTarget, NodeUpdateSource, OutSocket, Socket, SocketType, WebglOutputMapping, WebglOutputs, WebglSocketOutputs, WebglStdOut, webglStdOuts } from "$/node/";
import { webglDeclarations } from "$/color-management";
